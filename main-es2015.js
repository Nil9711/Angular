...
let EmailMeComponent = class EmailMeComponent {
...
EmailMeComponent.ctorParameters = () => [
...
let EmailsService = class EmailsService {
    ...
    addEmail(name, emailAdress, message) {
        const email = { id: null, name, emailAdress, message };
        this.http
